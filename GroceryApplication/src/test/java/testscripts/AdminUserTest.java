...
public class AdminUserTest extends TestNGBase {
	...
	public void verifyWhetherUserIsAbleToAddNewAdminUser() throws IOException {
		...
		adminuserpage.newButnClick().enterUserName(adminusername).enterUserPassword(adminpassword).userTypeDropdown()
				.clickSaveButton();
	...
	public void verifyWhetherUserIsAbleToSearchTheAddedUser() throws IOException {
		...
		Assert.assertEquals(actualUsername, Constant.newadduser, "Searched user is not displayed");
