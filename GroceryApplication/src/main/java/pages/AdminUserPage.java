...
public class AdminUserPage {
		...
		//new user actions
		@FindBy(xpath="//a[@href='javascript:void(0)'and@class='btn btn-rounded btn-danger']") WebElement newuser;
		@FindBy(xpath="//a[@href='javascript:void(0)'and@class='btn btn-rounded btn-danger']") WebElement newButnClick;
        @FindBy(id="username")  WebElement adminusername1;
        @FindBy(id="password")  WebElement adminpassword1;
        @FindBy(id="user_type")  WebElement userTypeDropdown;
        @FindBy(name="Create")   WebElement saveButton;
        
        //search button actions
        @FindBy(xpath="//a[@href='javascript:void(0)'and@class='btn btn-rounded btn-danger']") WebElement searchButton;
        @FindBy(id="un") WebElement enterusrname;
